...
- 📦 [v0.1.10 binaries](https://github.com/dandyArise/RepoLens/releases/tag/v0.1.10)
...
```powershell
.\install\install.ps1 -Version v0.1.10
...
```sh
REPOLENS_VERSION=v0.1.10 sh install/install.sh
