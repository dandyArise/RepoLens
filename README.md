...
- 📦 [v0.1.7 binaries](https://github.com/dandyArise/RepoLens/releases/tag/v0.1.7)
...
```powershell
.\install\install.ps1 -Version v0.1.7
...
```sh
REPOLENS_VERSION=v0.1.7 sh install/install.sh
